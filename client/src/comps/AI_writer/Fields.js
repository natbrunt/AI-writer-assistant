...
function Fields({setField, state}) {
  ...
  return (
        <div id="field container" className='flex flex-row items-center'>
            
            <div className="dropdown dropdown-bottom">
                <div tabIndex={0} role="button" className="btn m-1 bg-slate-200 text-black hover:bg-pink-500 hover:text-white border-2">{length == '' ? 'Length' : length}</div>
            ...
            <div className="dropdown dropdown-bottom">
                <div tabIndex={0} role="button" className="btn m-1 bg-slate-200 text-black hover:bg-pink-500 border-2">{tone == '' ? 'Tone' : tone}</div>
                <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow text-white">
                    <li className='flex flex-row items-center'><input
                    name="poetic"
                    className='h-5 w-5 mr-1'
            ...
            <div className="dropdown dropdown-bottom">
                <div tabIndex={0} role="button" className="btn m-1 bg-slate-200 text-black hover:bg-pink-500 border-2">{action == '' ? 'Action' : action}</div>
            ...
            <div id="input wrapper">
                <input //Name is taken care of and should be in the state obj
                    ...
                    className='outline outline-2 outline-black text-black rounded-xl ml-4 pl-2 bg-slate-200'
